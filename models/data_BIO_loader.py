...
class DataTterator(object):
    ...
    def get_batch(self, batch_num):
        ...
        for i, sample in enumerate(self.instances[batch_num]):
            ...
            spans_ner_label = sample['spans_aspect_label']# 标注所有aspect的位置
            spans_aspect2opinion_labels = sample['spans_aspect2opinion_label']# 对应的aspect元组
            spans_opinion_label = sample['spans_opinion_label']# 标注对应opinion的位置
